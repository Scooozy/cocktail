...
public interface ApiInterface {
    ...
    @GET("random.php")
    Call<CocktailsWrapper> getARandom();
    @GET("search.php?")
    Call<CocktailsWrapper> getByName(@Query("s") String nameDrink);
    @GET("filter.php?")
    Call<CocktailsWrapper> getByIngredient(@Query("i") String ingredientName);
